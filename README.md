...
Please run the app locally and capture screenshots for your final submission package:

- Dashboard (default)
- After selecting a few assets
...
- Add `admin@koinx.com` as collaborator
- Deploy app (Vercel/Netlify)
- Submit GitHub + deployed links in form:
  - https://forms.gle/kx1EQWT2yh3NKQcK7